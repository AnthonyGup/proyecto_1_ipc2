 ...
 * @author antho
 */
@WebServlet(name = "BuscadorTodosUsuarios", urlPatterns = {"/BuscadorTodosUsuarios"})
public class BuscadorTodosUsuarios extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (usuarios != null) {
                ...
                request.getRequestDispatcher("/Admin-congresos/cargador-usuarios.jsp").forward(request, response);
            }
