 ...
 * @author antho
 */
@WebServlet(name = "CreadorActividadesServlet", urlPatterns = {"/CreadorActividadesServlet"})
public class CreadorActividadesServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("mensaje", "Actividad creada exitosamente");
        } catch (ValidacionException ex) {
            request.setAttribute("error" , ex.getMessage());
        } catch (SQLException ex) {
            request.setAttribute("error", ex.getMessage());
        }
        request.getRequestDispatcher("/Admin-congresos/creador-actividades.jsp").forward(request, response);
    }
    
    private void crearActividad(HttpServletRequest request) throws ValidacionException, SQLException {
        //Obtener datos
