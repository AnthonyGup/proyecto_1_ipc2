<%-- 
    Document   : editor-salones
    Created on : 23 sept 2025, 1:49:34
    Author     : antho
--%>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 col-lg-6">
                <div class="mb-4 p-4 rounded bg-dark border border-secondary shadow-sm">
                    ...
                    <h4 class="mb-3">Editar salón</h4>

                    <form action="ActualizarSalonServlet" method="post">

                        <div class="mb-3">
                            <label class="form-label">ID Salón</label>
                            <p class="fw-bold mb-0">${salon.ID_SALON}</p>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="ubicacion" name="ubicacion"
                                   class="form-control border-secondary"
                                   style="background-color: #121212; color: #f8f9fa;"
                                   value="${salon.UBICACION}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" id="capacidad" name="capacidad" min="1"
                                   class="form-control border-secondary"
                                   style="background-color: #121212; color: #f8f9fa;"
                                   value="${salon.CAPACIDAD}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="id_congreso" name="id_congreso"
                                   ...
                                   value="${salon.ID_CONGRESO}" required>
                        </div>
